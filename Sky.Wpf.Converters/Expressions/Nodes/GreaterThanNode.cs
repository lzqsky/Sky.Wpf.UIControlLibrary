namespace Sky.Wpf.Converters.Expressions.Nodes
{
    // a node to determine whether the left node is greater than the right node
    internal sealed class GreaterThanNode : WideningBinaryNode
    {
